...
public class CanvasMyView extends View {
    public CanvasMyView(Context context, AttributeSet set) {
        super(context, set);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 绘制7个字符串
        canvas.drawText(getResources().getString(R.string.graphics_canvas_circle),
                60 + viewWidth * 3 / 5, viewWidth / 10 + 10, paint);
        canvas.drawText(getResources().getString(R.string.graphics_canvas_square),
                60 + viewWidth * 3 / 5, viewWidth * 3 / 10 + 20, paint);
        canvas.drawText(getResources().getString(R.string.graphics_canvas_rect),
                60 + viewWidth * 3 / 5, viewWidth * 1 / 2 + 20, paint);
        canvas.drawText(getResources().getString(R.string.graphics_canvas_round_rect),
                60 + viewWidth * 3 / 5, viewWidth * 3 / 5 + 30, paint);
        canvas.drawText(getResources().getString(R.string.graphics_canvas_oval),
                60 + viewWidth * 3 / 5, viewWidth * 7 / 10 + 30, paint);
        canvas.drawText(getResources().getString(R.string.graphics_canvas_triangle),
                60 + viewWidth * 3 / 5, viewWidth * 9 / 10 + 30, paint);
        canvas.drawText(getResources().getString(R.string.graphics_canvas_pentagon),
