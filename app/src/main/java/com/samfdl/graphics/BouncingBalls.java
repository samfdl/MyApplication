...
import com.samfdl.MainActivity;
import com.samfdl.R;

import java.util.ArrayList;

public class BouncingBalls extends AppCompatActivity {
    // 定义小球的大小的常量
    ...
    public class MyAnimationView extends View {
        public final ArrayList<ObjectAnimatorShapeHolder> balls
                = new ArrayList<ObjectAnimatorShapeHolder>();

        public MyAnimationView(Context context) {
            super(context);
            // 加载动画资源
            ObjectAnimator colorAnim = (ObjectAnimator) AnimatorInflater
                    .loadAnimator(BouncingBalls.this, R.animator.res_propertyanimation_color_anim);
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            ObjectAnimatorShapeHolder newBall = addBall(event.getX(), event.getY());
            // 计算小球下落动画开始时的y坐标
        ...
        private ObjectAnimatorShapeHolder addBall(float x, float y) {
            // 创建一个椭圆
            ...
            // 创建一个ShapeHolder对象
            ObjectAnimatorShapeHolder shapeHolder = new ObjectAnimatorShapeHolder(drawable);
            // 设置ShapeHolder的x、y坐标
        ...
        protected void onDraw(Canvas canvas) {
            ...
            for (ObjectAnimatorShapeHolder shapeHolder : balls) {
                // 保存canvas的当前坐标系统
                canvas.save();
