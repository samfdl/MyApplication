...
public class ValuesRes extends AppCompatActivity {
    // 获取系统定义的数组资源
    String[] texts;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        BaseAdapter ba = new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                TextView text = new TextView(ValuesRes.this);
                Resources res = ValuesRes.this.getResources();
                // 使用尺度资源来设置文本框的高度、宽度
                text.setWidth((int) res.getDimension(R.dimen.res_valuesres_cell_width));
                text.setHeight((int) res.getDimension(R.dimen.res_valuesres_cell_height));
                // 使用字符串资源设置文本框的内容
