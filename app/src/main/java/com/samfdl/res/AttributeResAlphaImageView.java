...
public class AttributeResAlphaImageView extends ImageView {
    // 图像透明度每次改变的大小
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 0x123) {
                ...
                // 修改该ImageView的透明度
                AttributeResAlphaImageView.this.setAlpha(curAlpha);
            }
        }
    };

    public AttributeResAlphaImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
