...
public class DesktopApp extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.desktop_desktopapp);  // ①
        // 为show ImageView设置图片
        remoteViews.setImageViewResource(R.id.show, R.drawable.desktop_desktopapp_logo);   // ②
