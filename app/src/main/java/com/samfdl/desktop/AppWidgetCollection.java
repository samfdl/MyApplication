...
public class AppWidgetCollection extends AppWidgetProvider {
    ...
    public void onUpdate(Context context,
        ...
        RemoteViews rv = new RemoteViews(context.getPackageName(),
                R.layout.desktop_appwidgetcollection);
        Intent intent = new Intent(context, AppWidgetCollectionService.class);
        ...
        Intent toastIntent = new Intent(context,
                AppWidgetCollection.class);
        // 为该Intent设置Action属性
        toastIntent.setAction(AppWidgetCollection.TOAST_ACTION);
        ...
        appWidgetManager.updateAppWidget(
                new ComponentName(context, AppWidgetCollection.class), rv); // ②
