...
public class LocationMap extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.map_locationmap);
        // 添加返回按钮
            ...
            public void onCheckedChanged(CompoundButton buttonView
                ...
                if (isChecked) {
                    ...
                    if (ActivityCompat.checkSelfPermission(LocationMap.this,
                            ...
                            && ActivityCompat.checkSelfPermission(LocationMap.this,
    ...
    private void updatePosition(Location location) {
        ...
        markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.map_locationmap_car));
        markerOptions.draggable(true);
...
//            CameraUpdate tiltUpdate = CameraUpdateFactory.changeLatLng(30);
            // 改变地图的倾斜度
