...
public class ContactProvider extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.io_contactprovider);
        // 添加返回按钮
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View source) {
                ...
                View resultDialog = getLayoutInflater().inflate(
                        R.layout.io_contactprovider_result, null);
                ...
                // 使用对话框来显示查询结果
                new AlertDialog.Builder(ContactProvider.this)
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getContentResolver().insert(android.provider.ContactsContract
                        .Data.CONTENT_URI, values);
                Toast.makeText(ContactProvider.this, "联系人数据添加成功",
