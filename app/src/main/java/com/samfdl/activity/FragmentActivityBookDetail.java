...
public class FragmentActivityBookDetail extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // 指定加载/res/layout目录下的activity_book_detail.xml布局文件
        // 该界面布局文件内只定义了一个名为book_detail_container的FrameLayout
        setContentView(R.layout.activity_fragment_activity_book_detail);
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putInt(FragmentBookDetail.ITEM_ID, getIntent()
                    .getIntExtra(FragmentBookDetail.ITEM_ID, 0));
            // 向Fragment传入参数
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent = new Intent(this, FragmentSenior.class);
