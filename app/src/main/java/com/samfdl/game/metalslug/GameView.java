...
public class GameView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public GameView(Context context, int firstStage) {
        ...
        // 初始化屏幕大小
        ViewManager.initScreen(MetalSlug.windowWidth,
    ...
    public Handler setViewHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if (layout != null) {
                ...
                MetalSlug.mainLayout.addView(layout, params);
            }
        }
    };
    ...
    public Handler delViewHandler = new Handler() {
        public void handleMessage(Message msg) {
            RelativeLayout layout = (RelativeLayout) msg.obj;
            if (layout != null) {
                MetalSlug.mainLayout.removeView(layout);
            }
        }
    };
    ...
    public int doGame(int step) {
        switch (step) {
            case INIT:
                ...
                if (gameLayout == null) {
                    ...
                    button.setBackground(getResources()
                            .getDrawable(R.drawable.game_metalslug_left));
                    RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                    ...
                    button.setBackground(getResources().getDrawable(
                            R.drawable.game_metalslug_right));
                    ...
                    // 设置按钮的背景图片
                    button.setBackground(getResources()
                            .getDrawable(R.drawable.game_metalslug_fire));
                    params = new RelativeLayout.LayoutParams(
                            LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
                    ...
                    // 设置按钮的背景图片
                    button.setBackground(getResources()
                            .getDrawable(R.drawable.game_metalslug_jump));
                    params = new RelativeLayout.LayoutParams(
                            LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
            ...
            case CLEAN:
                // 清除游戏界面
                if (gameLayout != null) {
                    delViewHandler.sendMessage(delViewHandler.obtainMessage(0,
                            gameLayout)); // ④
                    gameLayout = null;
                }
                break;
        ...
        switch (step) {
            case INIT:
                ...
                if (loginView == null) {
                    ...
                    loginView.setBackgroundResource(R.drawable.game_metalslug_game_back);
                    // 创建按钮
                    Button button = new Button(mainContext);
                    // 设置按钮的背景图片
                    button.setBackgroundResource(R.drawable.game_metalslug_button_selector);
                    RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                            LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        ...
        switch (step) {
            case INIT:
                ...
                if (loseView == null) {
                    ...
                    loseView.setBackgroundResource(R.drawable.game_metalslug_game_back);
                    Button button = new Button(mainContext);
                    button.setBackgroundResource(R.drawable.game_metalslug_again);
                    RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                            LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
                    params.addRule(RelativeLayout.CENTER_IN_PARENT);
