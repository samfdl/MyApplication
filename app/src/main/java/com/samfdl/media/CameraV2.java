...
public class CameraV2 extends AppCompatActivity implements View.OnClickListener {
    ...
    private CameraV2AutoFitTextureView textureView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        textureView = (CameraV2AutoFitTextureView) findViewById(R.id.texture);
        // 为该组件设置监听器
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            // 打开摄像头
            if (PackageManager.PERMISSION_GRANTED == ContextCompat.checkSelfPermission(CameraV2.this, Manifest.permission.CAMERA)) {
                //has permission, do operation directly
                manager.openCamera(mCameraId, stateCallback, null); // ①
            } else {
                if (ActivityCompat.shouldShowRequestPermissionRationale(CameraV2.this,
                        Manifest.permission.CAMERA)) {
                    manager.openCamera(mCameraId, stateCallback, null); // ①
                } else {
                    ActivityCompat.requestPermissions(CameraV2.this, new String[]{Manifest.permission.CAMERA}, 1);
                    manager.openCamera(mCameraId, stateCallback, null); // ①
                }
            }
        } catch (CameraAccessException e) {
            ...
            cameraDevice.createCaptureSession(Arrays.asList(surface, imageReader.getSurface()),
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigureFailed(CameraCaptureSession cameraCaptureSession) {
                            Toast.makeText(CameraV2.this, "配置失败！", Toast.LENGTH_SHORT).show();
                        }
                    }, null);
        } catch (CameraAccessException e) {
            e.printStackTrace();
            ...
            imageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader reader) {
                    ...
                    try (FileOutputStream output = new FileOutputStream(file)) {
                        output.write(bytes);
                        Toast.makeText(CameraV2.this, "保存: " + file, Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        e.printStackTrace();
                    } finally {
                        image.close();
