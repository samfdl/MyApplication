...
public class ViewSwitcher1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ui_viewanimator_viewswitcher);
        inflater = LayoutInflater.from(ViewSwitcher1.this);
        ...
        switcher.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                return inflater.inflate(R.layout.ui_viewanimator_viewswitcher_slidelistview, null);
            }
        });
        // 页面加载时先显示第一屏
        next(null);
    ...
    public void next(View v) {
        if (screenNo < screenCount - 1) {
            ...
            switcher.setInAnimation(this, R.anim.ui_viewanimator_viewswitcher_slide_in_right);
            // 为ViewSwitcher的组件隐藏过程设置动画
            switcher.setOutAnimation(this, R.anim.ui_viewanimator_viewswitcher_slide_out_left);
    ...
    private BaseAdapter adapter = new BaseAdapter() {
        ...
        public View getView(int position
            ...
            if (convertView == null) {
                ...
                view = inflater.inflate(R.layout.ui_viewanimator_viewswitcher_labelicon, null);
            }
