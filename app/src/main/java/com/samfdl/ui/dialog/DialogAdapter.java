...
/**
 * Created by samsung on 2016/8/30.
 */
public class DialogAdapter extends BaseAdapter {
    ...
    private ArrayList<String> getData() {
        ...
        listItem.add("AlertDialog");
        listItem.add("DialogTheme");
        listItem.add("PopupWindow");
        listItem.add("DatePickerDialog");
        listItem.add("ProgressDialog");
        return listItem;
    }
}