...
public class AlertDialog1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ui_dialog_alertdialog);
    ...
    public void simple(View source) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
                ...
                .setTitle("简单对话框")
                // 设置图标
                .setIcon(R.drawable.ui_toast_toast_tools)
                .setMessage("对话框的测试内容\n第二行内容");
    ...
    public void customList(View source) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
                ...
                .setAdapter(new ArrayAdapter<String>(this
                        , R.layout.ui_dialog_alertdialog_array_item
                        , items), null);
        // 为AlertDialog.Builder添加“确定”按钮
        setPositiveButton(builder);
        // 为AlertDialog.Builder添加“取消”按钮
    ...
    public void customView(View source) {
        ...
        TableLayout loginForm = (TableLayout) getLayoutInflater()
                .inflate(R.layout.ui_dialog_alertdialog_login, null);
