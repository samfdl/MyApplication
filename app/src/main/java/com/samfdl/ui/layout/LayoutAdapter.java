...
public class LayoutAdapter extends BaseAdapter {
    ...
    private ArrayList<String> getData() {
        ...
        listItem.add("LinearLayout");
        listItem.add("RelativeLayout");
        listItem.add("FrameLayout");
        listItem.add("GridLayout");
        listItem.add("AbsoluteLayout");
        listItem.add("TableLayout");
        return listItem;
    }
}