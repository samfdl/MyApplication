...
public class ListViewAdapter extends BaseAdapter {
    ...
    private ArrayList<String> getData() {
        ...
        listItem.add("SimpleListView");
        listItem.add("ArrayAdapterListView");
        listItem.add("ListActivity");
        listItem.add("SimpleAdapterListView");
        listItem.add("BaseAdapterListView");
        listItem.add("AutoCompleteTextView");
        listItem.add("GridView");
        listItem.add("ExpandableListView");
