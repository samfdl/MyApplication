...
public class SwipeNav extends AppCompatActivity implements ActionBar.TabListener {
    ViewPager viewPager;
    ActionBar actionBar;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ui_actionbar_swipenav);
        // 获取ActionBar对象
        ...
        FragmentPagerAdapter pagerAdapter = new FragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                Fragment fragment = new SwipeNavFragment();
                Bundle args = new Bundle();
                args.putInt(TabNavFragment.ARG_SECTION_NUMBER, position + 1);
