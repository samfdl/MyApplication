...
public class ToastAdapter extends BaseAdapter {
    ...
    private ArrayList<String> getData() {
        ...
        listItem.add("Toast");
        listItem.add("CalendarView");
        listItem.add("DatePicker 和 TimePicker");
        listItem.add("NumberPicker");
        listItem.add("SearchView");
        listItem.add("TabHost");
        listItem.add("ScrollView");
